...
# Run this initially
# Data is till 2025-04-15
# Use download_daily_weather.py to download from 16th onwards
borough_map = {
...
for borough in borough_map:
    ...
    daily_dataframe.to_csv(f"weather_{borough}.csv", index=False, header=True)
    print(f"Saved to file weather_{borough}.csv")
